...
namespace MainUI.Procedure.User
{
    partial class ucPermissionAllocation
    {
        ...
        private void InitializeComponent()
        {
            ...
            PanelPermissions = new UIFlowLayoutPanel();
            uiLine1 = new UILine();
            ...
            // PanelPermissions
            // 
            PanelPermissions.BackColor = Color.Transparent;
            PanelPermissions.FillColor = Color.White;
            PanelPermissions.FillColor2 = Color.White;
            ...
            PanelPermissions.RectColor = Color.White;
            PanelPermissions.RectDisableColor = Color.White;
            PanelPermissions.ShowText = false;
            PanelPermissions.Size = new Size(665, 504);
            PanelPermissions.TabIndex = 15;
            PanelPermissions.Text = "uiFlowLayoutPanel1";
            PanelPermissions.TextAlignment = ContentAlignment.MiddleCenter;
            // 
            // uiLine1
            // 
            ...
            uiLabel2.Location = new Point(208, 58);
            ...
            cboRole.Location = new Point(259, 56);
            ...
            btnEdit.Location = new Point(507, 610);
        ...
        private UIFlowLayoutPanel PanelPermissions;
    }
}
